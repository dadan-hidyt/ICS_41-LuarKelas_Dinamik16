...
<nav style="background: #f5f5f5;border-bottom: 3px solid #f5a352;" class="navbar navbar-expand-lg navbar-light ">
 <div class="container">
  <a class="navbar-brand" href="<?php echo(base_url()) ?>"><img width="40px" src="<?= base_url() ?>assets/img/logo.png" alt=""></a>
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav ml-auto">
      <a class="nav-item nav-link f" href="<?php echo base_url(); ?>">Home</a>
      <a class="nav-item nav-link f" href="<?php echo base_url(); ?>roadmap">Cari Peta</a>
      <a class="nav-item nav-link f" href="<?php echo base_url(); ?>#faqs">Faqs</a>
      <?php
      if ($session->isLogin()) {
        ...
        <div class="profil-icon1">
          <div class="dropdown show">
            <img id="img-profile1" src="<?php echo base_url() ?>images/useravatar/<?php echo $row->avatar ?>" width="60px" height="50px" style="border-radius:100%;" class="btn dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></a>
            <div class="dropdown-menu profil-info-desk" aria-labelledby="dropdownMenuLink">
              <div class="profil-img mt-2 text-center" style="display: flex; flex-direction: column; align-items: center;">
                <img src="<?php echo base_url() ?>images/useravatar/<?php echo $row->avatar ?>" width="80px" height="70px" style="border-radius:100%;" class="btn dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></a>
                <span class="mt-3 mb-0" style="font-size: 14px;"> 
...
if($session->isLogin()){
  ...
  <div class="modal fade" id="account" tabindex="-1" role="dialog" aria-labelledby="titel" aria-hidden="true">
        ...
        <div class="modal-body">
          <div class="box-info-profil">
            ...
            <div class="img-profil-info">
              <img id="img-profile2" src="<?php echo base_url() ?>images/useravatar/<?php echo $row->avatar ?>" width="80px" height="70px" style="border-radius:100%;" class="btn dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"></a>
              <br>  
          ...
          <div class="ganti-info-akun">
             <label for="nama"> Nama <br>
              ...
              style="outline:none;border:none;padding:4px;border-radius: 5px;width:100%; background-color: rgba(64, 224, 208, 0.191);">
            </label>
            <br>
            <label for="nama">
            </div>
            <div class="save-info-akun">
              <a href="#" class="btn btn-tutup" data-dismiss="modal" style="color:#fff;background-color:#f5a352;"> Close</a>
              <button type="submit" name="submit" class="posting-pertanyaan  btn" style="color:#fff;
